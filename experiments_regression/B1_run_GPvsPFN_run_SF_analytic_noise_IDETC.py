...
# %% Zakharov -------------------------------------------------------------
zakharov_GPvsPFN(title=title, num_runs=num_runs, train_size=5, dimensions=20, save_path=save_path_zakharov, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
zakharov_GPvsPFN(title=title, num_runs=num_runs, train_size=20, dimensions=20, save_path=save_path_zakharov, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
zakharov_GPvsPFN(title=title, num_runs=num_runs, train_size=5, dimensions=20, save_path=save_path_zakharov, noise_train=0.08, noise_test=0.08, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
zakharov_GPvsPFN(title=title, num_runs=num_runs, train_size=20, dimensions=20, save_path=save_path_zakharov, noise_train=0.08, noise_test=0.08, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)

# %% Griewank -------------------------------------------------------------
griewank_GPvsPFN(title=title, num_runs=num_runs, train_size=5, dimensions=20, save_path=save_path_griewank, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
griewank_GPvsPFN(title=title, num_runs=num_runs, train_size=20, dimensions=20, save_path=save_path_griewank, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
griewank_GPvsPFN(title=title, num_runs=num_runs, train_size=5, dimensions=20, save_path=save_path_griewank, noise_train=0.08, noise_test=0.08, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
griewank_GPvsPFN(title=title, num_runs=num_runs, train_size=20, dimensions=20, save_path=save_path_griewank, noise_train=0.08, noise_test=0.08, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
...
# %% Dixon Price -------------------------------------------------------------  
dixon_price_GPvsPFN(title=title, num_runs=num_runs, train_size=5, dimensions=40, save_path=save_path_dixon_price, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
dixon_price_GPvsPFN(title=title, num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_dixon_price, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
dixon_price_GPvsPFN(title=title, num_runs=num_runs, train_size=5, dimensions=40, save_path=save_path_dixon_price, noise_train=0.08, noise_test=0.08, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
dixon_price_GPvsPFN(title=title, num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_dixon_price, noise_train=0.08, noise_test=0.08, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
...
# # %% Rosenbrock (skipped — already in results/A6_rosenbrock/LOO) -------------
# rosenbrock_GPvsPFN(title=title, num_runs=num_runs, train_size=5, dimensions=80, save_path=save_path_rosenbrock, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
# rosenbrock_GPvsPFN(title=title, num_runs=num_runs, train_size=20, dimensions=80, save_path=save_path_rosenbrock, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
# rosenbrock_GPvsPFN(title=title, num_runs=num_runs, train_size=5, dimensions=80, save_path=save_path_rosenbrock, noise_train=0.08, noise_test=0.08, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
# rosenbrock_GPvsPFN(title=title, num_runs=num_runs, train_size=20, dimensions=80, save_path=save_path_rosenbrock, noise_train=0.08, noise_test=0.08, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type)
