...
# # %% Rosenbrock -------------------------------------------------------------
set_pe_sf_kernel(80)
# rosenbrock_GPvsPFN(title=title, num_runs=1, train_size=5, dimensions=10, save_path=None, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type, kernel_type=kernel_type, trainer_info=False, log_lbfgs_inner=False)
# rosenbrock_GPvsPFN(title=title, num_runs=1, train_size=5, dimensions=80, save_path=None, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type, kernel_type=kernel_type, trainer_info=False, log_lbfgs_inner=False)
# rosenbrock_GPvsPFN(title=title, num_runs=num_runs, train_size=5, dimensions=80, save_path=save_path_rosenbrock, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type, kernel_type=kernel_type, trainer_info=False, log_lbfgs_inner=False)
rosenbrock_GPvsPFN(title=title, num_runs=num_runs, train_size=20, dimensions=80, save_path=save_path_rosenbrock, noise_train=0.002, noise_test=0.002, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type, kernel_type=kernel_type, trainer_info=False, log_lbfgs_inner=False)
rosenbrock_GPvsPFN(title=title, num_runs=num_runs, train_size=5, dimensions=80, save_path=save_path_rosenbrock, noise_train=0.08, noise_test=0.08, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type, kernel_type=kernel_type, trainer_info=False, log_lbfgs_inner=False)
rosenbrock_GPvsPFN(title=title, num_runs=num_runs, train_size=20, dimensions=80, save_path=save_path_rosenbrock, noise_train=0.08, noise_test=0.08, num_test=num_test, num_inits=num_inits, run_models=run_models, loss_type=loss_type, kernel_type=kernel_type, trainer_info=False, log_lbfgs_inner=False)
